...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--translation_style', type=str, help='Specifies the style to be used in the translation of the text.This can influence tone, formality, and other stylistic aspects of the translation.Common styles include "formal", "informal", "literary", "technical", etc.Choose a style that best fits the intended audience and purpose of the translated content.')
